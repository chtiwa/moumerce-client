...
const CheckoutPage = () => {
  ...
  const [form, setForm] = useState({ firstName: '', lastName: '', state: '', address: '', phone: '' })
  const [formBlur, setFormBlur] = useState({ firstName: false, lastName: false, state: false, address: false, phone: false })
  const [errors, setErrors] = useState({ firstName: '', lastName: '', state: '', address: '', phone: '' })
  ...
  const handleClick = () => {
    if (!isValid()) {
      dispatch(openPopup({ message: 'The form must be filled before ordering!', success: false }))
      return
    }
  ...
  const validate = (form: Form) => {
    let errors: any = { firstName: "", lastName: "", address: "", phone: "", state: "" }
  ...
  const isValid = () => {
    return (
      errors.firstName.length === 0 && errors.lastName.length === 0 && errors.address.length === 0 && errors.state.length === 0 && errors.phone.length === 0 && form.firstName.length !== 0 && form.lastName.length !== 0 && form.address.length !== 0 && form.state.length !== 0 && form.phone.length !== 0
    )
  }
      ...
      <div className="wrapper">
        ...
        <form>
          ...
          <div className="form-control">
            ...
            <div className="inner">
              <input type="text" name="address" value={form.address || ''} onChange={handleChange} onBlur={() => setFormBlur({ ...formBlur, address: true })} />
          ...
          <div className="form-control">
            ...
            <div className="inner">
              <input type="tel" name="phone" value={form.phone || ''} onChange={handleChange} onBlur={() => setFormBlur({ ...formBlur, phone: true })} />
