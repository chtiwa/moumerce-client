...
export const productsApi = createApi({
  ...
  baseQuery: fetchBaseQuery({ baseUrl: `${import.meta.env.VITE_SERVER_URL}/products` }),
  endpoints: (builder) => ({
...
export const { useGetProductsQuery, useGetProductQuery, useGetFeaturedProductsQuery, useSearchProductsQuery } = productsApi